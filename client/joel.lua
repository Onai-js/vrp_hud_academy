...
-----------------------------------------------------------------------------------------------------------------------------------------
cRP = {}
Tunnel.bindInterface("hex_hud",cRP)
...
RegisterKeyMapping('hud:interact', 'Abrir menu de interaA§A£o', 'keyboard', 'I')
...
RegisterCommand('hud:interact', function()
        ...
        if not IsPedInAnyVehicle(ped) then
                ...
                TriggerEvent("Notify","negado","VocAª nA£o pode abrir o menu em um veA-culo.")
        end
end)
